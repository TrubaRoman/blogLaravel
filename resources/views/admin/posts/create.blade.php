            ...
            <div class="box-body">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        {{Form::select('tags[]',$tags,
                            null,
                            ['class' => 'form-control select2','multiple'=> 'multiple','data-placeholder' => 'Виберіть тег'])}}
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="descriptions" id="" cols="30" rows="10" class="form-control">{{old('descriptions')}}</textarea>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
