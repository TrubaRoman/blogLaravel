<ul class="sidebar-menu">
    <li class="header">Моя навігація</li>
    <li class="treeview">
        <a href="#">
    ...
    <li><a href="{{route('subscribers.index')}}"><i class="fa fa-user-plus"></i> <span>Подписчики</span>
            <span class="pull-right-container">
              <small class="label pull-right bg-green">{{$SubscribersCount}}</small>
            </span>
        </a></li>
