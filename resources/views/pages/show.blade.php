            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="top-comment"><!--top comment-->
                        <img src="{{$post->author->getAvatar()}}" class="pull-left img-circle" alt="" style="width: 100px;height: 100px">
                        <h4>{{$post->author->name}}</h4>

                        <p>{{$post->author->status_text}}</p>
                    </div><!--top comment end-->
                    ...
                    <div class="bottom-comment"><!--bottom comment-->
                        ...
                        <div class="comment-img">
                            <img class="img-circle" src="{{$comment->author->getAvatar()}}" style="width: 75px;height:85px;" alt="">
                        </div>
